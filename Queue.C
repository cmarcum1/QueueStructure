...
//Queue Structure
//Project Overview: The queue structure was a small peice of the puzzle of a semester long project.
//					It held the process control blocks (PCBs).  
//					I wrote the code (it was my portion of the module) and a the members of the group
//					(Samantha Brooks, Dirk Berezovske,Nixy Osorio) debugged it.
//					It has all of the functions for a queue and for on of the queues (which is just a linked list)
//					there is sorting methods.
